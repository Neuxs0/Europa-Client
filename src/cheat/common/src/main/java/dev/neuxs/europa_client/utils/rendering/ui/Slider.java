...
//
//        boolean mouseOver = this.interactionButton.getState() != Renderer.State.NORMAL;
//        boolean mousePressed = InputManager.isMouseButtonDown(Input.Buttons.LEFT);
//
//        boolean canStartDrag = mouseOver && mousePressed && this.interactionButton.getState() == Renderer.State.PRESSED;
//
